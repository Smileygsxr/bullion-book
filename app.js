...
document.addEventListener('DOMContentLoaded', function () {
    const dateInput = document.getElementById('xauusdDate');
    const caption = document.getElementById('xauusdDateCaption');

    function updateChartCaption() {
        if (dateInput && caption) {
            caption.textContent = `XAUUSD 5m • ${dateInput.value}`;
        }
    }

    if (dateInput) {
        dateInput.addEventListener('change', updateChartCaption);
        updateChartCaption();
    }
});
/////////////////////////////////////////////////////////////////////////////////////////////////////////
